...
function TodoItem() {
    ...
    const [selecteTodo, setSelectedTodo] = useState(null)

    const editTodolocal = (todoObj) => {
    ...
    return (
        <>
            <TodoForm todo={selecteTodo} editMode={editMode} setEditMode={setEditMode} />
            <div>Todos</div>
